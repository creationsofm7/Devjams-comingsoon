...
const SocialMediaBar = () => {
  return (
    <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 md:gap-8 m-4">
      <SocialIcon>
      ...
      <div className="relative w-24 h-24 sm:w-32 sm:h-32 md:w-40 md:h-40 p-2 sm:p-3 md:p-4 bg-gray-900 rounded-full flex items-center justify-center border-2">
        <img src="/vite.svg" alt="Vite logo" className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20" />
      </div>
...
const SocialIcon = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 border-2 bg-gray-900 rounded-full flex items-center justify-center text-white hover:bg-gray-800 transition-colors duration-300">
      {children}
    </div>
  );
};
